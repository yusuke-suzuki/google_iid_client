...
module GoogleIidClient
  class InlineObject1
    ...
    # The array of IID tokens for the app instances you want to remove.
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'registration_tokens')
        if (value = attributes[:'registration_tokens']).is_a?(Array)
          self.registration_tokens = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          to == o.to &&
          registration_tokens == o.registration_tokens
    end
